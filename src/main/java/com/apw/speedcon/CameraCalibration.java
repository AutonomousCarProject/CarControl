...
public class CameraCalibration {
	...
	To use, you need to create a square the size of testBlobWidthHeight at the distance
	testBlobDistance, then begine calibration which takes a picure
	and measures the the square thus filling needed variables. After calibration, you can find the
  ...
  private double testBlobWidthHeight; //the width and height of a square used to calibrate the
  // camera
