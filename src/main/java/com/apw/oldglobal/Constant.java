...
public class Constant {
    ...
    public static void setVariable(int index, double a) {
        switch (index) {
            case 1:
                MAX_TIME_OFF_SCREEN = (int) a;
                break;
            case 2:
                DISTANCE_LIMIT_X = (int) a;
                break;
            case 3:
                DISTANCE_LIMIT_Y = (int) a;
                break;
            case 4:
                MAX_CHANGE_WIDTH = (int) a;
                break;
            case 5:
                MAX_CHANGE_HEIGHT = (int) a;
                break;
            case 14:
                AGE_MIN = (int) a;
                break;
            case 15:
                VELOCITY_X_MAX = (int) a;
                break;
            case 16:
                VELOCITY_Y_MAX = (int) a;
                break;
            case 17:
                MAX_VELOCITY_CHANGE_X = (float) a;
                break;
            case 18:
                MAX_VELOCITY_CHANGE_Y = (float) a;
                break;
            case 19:
                MAX_WIDTH_HEIGHT_RATIO = (float) a;
                break;
            case 20:
                MAX_WIDTH = (int) a;
                break;
            case 21:
                ...
                break;
            case 22:
                MIN_SCALED_VELOCITY_X = (int) a;
                break;
            case 23:
                MIN_SCALED_VELOCITY_Y = (int) a;
                break;
        }
    }
    ...
    public static double getVariable(int index) {
        switch (index) {
            case 1:
                return MAX_TIME_OFF_SCREEN;
            case 2:
                return DISTANCE_LIMIT_X;
            case 3:
                return DISTANCE_LIMIT_Y;
            case 4:
                return MAX_CHANGE_WIDTH;
            case 5:
                return MAX_CHANGE_HEIGHT;
            case 14:
                return AGE_MIN;
            case 15:
            ...
            case 17:
                return MAX_VELOCITY_CHANGE_X;
            case 18:
                return MAX_VELOCITY_CHANGE_Y;
            case 19:
                return MAX_WIDTH_HEIGHT_RATIO;
            case 20:
                return MAX_WIDTH;
            case 21:
                return MAX_HEIGHT;
            case 22:
                return MIN_SCALED_VELOCITY_X;
            case 23:
                return MIN_SCALED_VELOCITY_Y;
