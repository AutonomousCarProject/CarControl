  ...
  @Override public void paint(Graphics graf) { // (in DrDemo)
    ...
    if (thePixels != null) try {
      ...
      if (GetCameraImg()) {
        ...
        graf.drawRect(Constants.STOPLIGHT_MIN_WIDTH, Constants.STOPLIGHT_MIN_HEIGHT, Constants.STOPLIGHT_MAX_WIDTH-Constants.STOPLIGHT_MIN_WIDTH, Constants.STOPLIGHT_MAX_HEIGHT-Constants.STOPLIGHT_MIN_HEIGHT);
